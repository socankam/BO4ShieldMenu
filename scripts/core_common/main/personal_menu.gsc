PersonalMenu(){
    ...
    self addToggleOption("FunOptions", "Flashing Camo", &RainbowCamo, false);
    ...
    if(level.CurrentMap == "mp_nuketown_4"){
        self addOption("SpawnEnemies", "Spawn Zombie Mannequin", &ZombieMannequin, "1");
    ...
    if (!isDefined(self.customzombies)){
        ...
        //self addOption("SpecialistMenu", "Buy Attack Dog ($2,500)", &BuyAttackDog, []);
